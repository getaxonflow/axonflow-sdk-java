 ...
 *
 * <p>This class contains all types for the MAS FEAT (Monetary Authority of Singapore - Fairness,
 * Ethics, Accountability, Transparency) compliance module.
 *
...
public final class MASFEATTypes {
  ...
  public static class Finding {
    ...
    public FEATPillar getPillar() {
      return pillar;
    }

    public void setPillar(FEATPillar pillar) {
      this.pillar = pillar;
    }
    ...
    public static class Builder {
      ...
      public Builder pillar(FEATPillar pillar) {
        this.pillar = pillar;
        return this;
      }
      ...
      public Builder status(FindingStatus status) {
        this.status = status;
        return this;
      }
  ...
  public static class RegisterSystemRequest {
    ...
    public AISystemUseCase getUseCase() {
      return useCase;
    }
    ...
    public int getHumanReliance() {
      return humanReliance;
    }
    ...
    public static class Builder {
      ...
      public Builder useCase(AISystemUseCase useCase) {
      ...
      public Builder customerImpact(int customerImpact) {
        this.customerImpact = customerImpact;
        return this;
      }

      public Builder modelComplexity(int modelComplexity) {
        this.modelComplexity = modelComplexity;
        return this;
      }

      public Builder humanReliance(int humanReliance) {
        this.humanReliance = humanReliance;
        return this;
      }
      ...
      public Builder technicalOwner(String technicalOwner) {
        this.technicalOwner = technicalOwner;
        return this;
      }

      public Builder businessOwner(String businessOwner) {
  ...
  public static class AISystemRegistry {
    ...
    public void setUseCase(AISystemUseCase useCase) {
      this.useCase = useCase;
    }
    ...
    public void setCustomerImpact(int customerImpact) {
      this.customerImpact = customerImpact;
    }
    ...
    public void setHumanReliance(int humanReliance) {
      this.humanReliance = humanReliance;
    }

    public MaterialityClassification getMaterialityClassification() {
      return materialityClassification;
    }

    public void setMaterialityClassification(MaterialityClassification materialityClassification) {
      this.materialityClassification = materialityClassification;
    }
  ...
  public static class RegistrySummary {
    ...
    public int getHighMaterialityCount() {
      return highMaterialityCount;
    }

    public void setHighMaterialityCount(int highMaterialityCount) {
      this.highMaterialityCount = highMaterialityCount;
    }

    public int getMediumMaterialityCount() {
      return mediumMaterialityCount;
    }

    public void setMediumMaterialityCount(int mediumMaterialityCount) {
      this.mediumMaterialityCount = mediumMaterialityCount;
    }

    public int getLowMaterialityCount() {
      return lowMaterialityCount;
    }
  ...
  public static class CreateAssessmentRequest {
    ...
    public static class Builder {
      ...
      public Builder assessors(List<String> assessors) {
  ...
  public static class UpdateAssessmentRequest {
    ...
    public Integer getEthicsScore() {
      return ethicsScore;
    }

    public Integer getAccountabilityScore() {
    ...
    public Map<String, Object> getFairnessDetails() {
      return fairnessDetails;
    }

    public Map<String, Object> getEthicsDetails() {
      return ethicsDetails;
    }

    public Map<String, Object> getAccountabilityDetails() {
      return accountabilityDetails;
    }

    public Map<String, Object> getTransparencyDetails() {
    ...
    public static class Builder {
      ...
      public Builder fairnessScore(int score) {
        this.fairnessScore = score;
        return this;
      }

      public Builder ethicsScore(int score) {
        this.ethicsScore = score;
        return this;
      }

      public Builder accountabilityScore(int score) {
        this.accountabilityScore = score;
        return this;
      }

      public Builder transparencyScore(int score) {
        this.transparencyScore = score;
        return this;
      }

      public Builder fairnessDetails(Map<String, Object> details) {
        this.fairnessDetails = details;
        return this;
      }

      public Builder ethicsDetails(Map<String, Object> details) {
        this.ethicsDetails = details;
        return this;
      }

      public Builder accountabilityDetails(Map<String, Object> details) {
        this.accountabilityDetails = details;
        return this;
      }

      public Builder transparencyDetails(Map<String, Object> details) {
        this.transparencyDetails = details;
        return this;
      }
  ...
  public static class FEATAssessment {
    ...
    public FEATAssessmentStatus getStatus() {
      return status;
    }

    public void setStatus(FEATAssessmentStatus status) {
      this.status = status;
    }
    ...
    public void setEthicsScore(Integer ethicsScore) {
    ...
    public void setAccountabilityScore(Integer accountabilityScore) {
    ...
    public void setFairnessDetails(Map<String, Object> fairnessDetails) {
      this.fairnessDetails = fairnessDetails;
    }
    ...
    public void setEthicsDetails(Map<String, Object> ethicsDetails) {
      this.ethicsDetails = ethicsDetails;
    }
    ...
    public void setAccountabilityDetails(Map<String, Object> accountabilityDetails) {
      this.accountabilityDetails = accountabilityDetails;
    }
    ...
    public void setTransparencyDetails(Map<String, Object> transparencyDetails) {
      this.transparencyDetails = transparencyDetails;
    }
  ...
  public static class KillSwitch {
    ...
    public void setStatus(KillSwitchStatus status) {
      this.status = status;
    }
  ...
  public static class ConfigureKillSwitchRequest {
    ...
    public static class Builder {
      ...
      public Builder biasThreshold(double threshold) {
      ...
      public Builder autoTriggerEnabled(boolean enabled) {
  ...
  public static class CheckKillSwitchRequest {
    ...
    public static class Builder {
      ...
      public Builder biasScore(double biasScore) {
  ...
  public static class RestoreKillSwitchRequest {
    ...
    public static class Builder {
      ...
      public Builder restoredBy(String restoredBy) {
        this.restoredBy = restoredBy;
        return this;
      }
  ...
  public static class KillSwitchEvent {
    ...
    public String getKillSwitchId() {
      return killSwitchId;
    }

    public void setKillSwitchId(String killSwitchId) {
