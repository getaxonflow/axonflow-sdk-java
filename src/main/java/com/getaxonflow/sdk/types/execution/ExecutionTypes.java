 ...
 *
 * <p>These types provide a consistent interface for tracking both Multi-Agent Planning (MAP) and
 * Workflow Control Plane (WCP) executions. The unified schema enables consistent status tracking,
 * progress reporting, and cost tracking across execution types.
 *
 * <p>Issue #1075 - EPIC #1074: Unified Workflow Infrastructure
 */
public final class ExecutionTypes {
  ...
  public static final class UnifiedStepStatus {
    ...
    public UnifiedStepType getStepType() {
      return stepType;
    }
    ...
    public UnifiedGateDecision getDecision() {
      return decision;
    }
    ...
    public List<String> getPoliciesMatched() {
      return policiesMatched;
    }

    public UnifiedApprovalStatus getApprovalStatus() {
    ...
    public static final class Builder {
      ...
      public Builder stepType(UnifiedStepType stepType) {
        this.stepType = stepType;
        return this;
      }

      public Builder status(StepStatusValue status) {
        this.status = status;
        return this;
      }
      ...
      public Builder decision(UnifiedGateDecision decision) {
        this.decision = decision;
        return this;
      }
      ...
      public Builder policiesMatched(List<String> policiesMatched) {
        this.policiesMatched = policiesMatched;
        return this;
      }

      public Builder approvalStatus(UnifiedApprovalStatus approvalStatus) {
        this.approvalStatus = approvalStatus;
        return this;
      }
  ...
  public static final class ExecutionStatus {
    ...
    public ExecutionStatusValue getStatus() {
      return status;
    }
    ...
    public List<UnifiedStepStatus> getSteps() {
      return steps;
    }
    ...
    public static final class Builder {
      ...
      public Builder status(ExecutionStatusValue status) {
        this.status = status;
        return this;
      }

      public Builder currentStepIndex(int currentStepIndex) {
        this.currentStepIndex = currentStepIndex;
        return this;
      }
      ...
      public Builder estimatedCostUsd(Double estimatedCostUsd) {
        this.estimatedCostUsd = estimatedCostUsd;
        return this;
      }

      public Builder actualCostUsd(Double actualCostUsd) {
        this.actualCostUsd = actualCostUsd;
        return this;
      }

      public Builder steps(List<UnifiedStepStatus> steps) {
        this.steps = steps;
        return this;
      }
