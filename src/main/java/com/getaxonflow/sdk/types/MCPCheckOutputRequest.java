 ...
 *
 * <p>Used with the {@code POST /api/v1/mcp/check-output} endpoint to check
 * response data for PII, exfiltration limits, and other policy violations.</p>
 */
...
public final class MCPCheckOutputRequest {
     ...
     */
    public MCPCheckOutputRequest(String connectorType, List<Map<String, Object>> responseData,
                                 String message, Map<String, Object> metadata, int rowCount) {
