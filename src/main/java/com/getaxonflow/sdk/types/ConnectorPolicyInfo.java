 ...
 *
 * <p>Provides transparency into policy enforcement decisions for request blocking and response
 * redaction.
 */
...
public final class ConnectorPolicyInfo {
  ...
  /**
   * Returns exfiltration check information (Issue #966). May be null if exfiltration checking is
   * disabled.
   */
  ...
  /**
   * Returns dynamic policy evaluation information (Issue #968). May be null if dynamic policies are
   * disabled.
   */
