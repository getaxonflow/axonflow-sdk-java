 ...
 * <ul>
 *   <li>Creating webhook subscriptions</li>
 *   <li>Updating webhook subscriptions</li>
 *   <li>Listing webhook subscriptions</li>
 * </ul>
 */
public final class WebhookTypes {
    ...
    public static final class ListWebhooksResponse {
        ...
        public ListWebhooksResponse(
            ...
            this.webhooks = webhooks != null ? Collections.unmodifiableList(webhooks) : Collections.emptyList();
            this.total = total;
        }
