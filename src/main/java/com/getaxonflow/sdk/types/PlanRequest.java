 ...
 *
 * <p>Multi-Agent Planning allows you to describe a complex task and have AxonFlow generate an
 * execution plan with multiple steps that can be executed by different agents.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class PlanRequest {
  ...
  public static final class Builder {
     ...
     *
     * <ul>
     *   <li>generic - General purpose planning
     *   <li>travel - Travel and booking workflows
     *   <li>healthcare - Healthcare data processing
     *   <li>finance - Financial analysis workflows
     * </ul>
     *
