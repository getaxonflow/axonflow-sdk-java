...
public final class PlanStep {
  ...
  public PlanStep(
    ...
    this.dependsOn =
        dependsOn != null ? Collections.unmodifiableList(dependsOn) : Collections.emptyList();
    this.agent = agent;
    this.parameters =
   ...
   *
   * <ul>
   *   <li>llm-call - LLM inference
   *   <li>api-call - External API call
   *   <li>connector-call - MCP connector query
   *   <li>conditional - Conditional logic
   *   <li>function-call - Custom function execution
   * </ul>
   *
