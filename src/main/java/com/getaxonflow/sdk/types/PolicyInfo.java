...
public final class PolicyInfo {
  ...
  public PolicyInfo(
    ...
    this.staticChecks =
        staticChecks != null ? Collections.unmodifiableList(staticChecks) : Collections.emptyList();
  ...
  public int hashCode() {
    return Objects.hash(
        policiesEvaluated, staticChecks, processingTime, tenantId, riskScore, codeArtifact);
  }
