 ...
 *
 * <p>The version field is used for optimistic concurrency control. If the version does not match
 * the current server version, a {@link com.getaxonflow.sdk.exceptions.VersionConflictException} is
 * thrown.
 *
 * <p>Example usage:
 *
