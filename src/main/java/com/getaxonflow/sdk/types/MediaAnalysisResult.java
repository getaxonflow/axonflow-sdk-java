...
public final class MediaAnalysisResult {
  ...
  public MediaAnalysisResult(
    ...
    this.hasPII = hasPII;
    this.piiTypes =
        piiTypes != null ? Collections.unmodifiableList(piiTypes) : Collections.emptyList();
  ...
  public boolean isHasBiometricData() {
  ...
  public boolean isSensitiveDocument() {
    return isSensitiveDocument;
  }

  public boolean isHasPII() {
    return hasPII;
  }
  ...
  public String toString() {
    return "MediaAnalysisResult{mediaIndex="
        + mediaIndex
        + ", contentSafe="
        + contentSafe
        + ", hasPII="
