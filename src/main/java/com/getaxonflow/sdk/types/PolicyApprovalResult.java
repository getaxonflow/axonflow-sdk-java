 ...
 *
 * <p>This response indicates whether the request is approved to proceed to the LLM call. If
 * approved, the {@code contextId} must be used in the subsequent audit call.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class PolicyApprovalResult {
   ...
   *
   * <p>When true, PII was detected with redact action and the response should be processed for
   * redaction before being shown to users.
   *
   ...
   *
   * <p>This may contain redacted or filtered versions of sensitive data that is safe to send to the
   * LLM.
   *
