...
public final class CostControlTypes {
  ...
  public static class CreateBudgetRequest {
    ...
    public BudgetOnExceed getOnExceed() {
      return onExceed;
    }
    ...
    public static class Builder {
      ...
      public Builder onExceed(BudgetOnExceed onExceed) {
  ...
  public static class ListBudgetsOptions {
    ...
    public static class Builder {
      ...
      public ListBudgetsOptions build() {
        return new ListBudgetsOptions(this);
      }
    }
  }
  ...
  public static class BudgetCheckRequest {
    ...
    public static class Builder {
      ...
      public BudgetCheckRequest build() {
        return new BudgetCheckRequest(this);
      }
    }
  }
  ...
  public static class UsageSummary {
    ...
    public Integer getTotalTokensIn() {
      return totalTokensIn;
    }

    public Integer getTotalTokensOut() {
  ...
  public static class UsageBreakdown {
    ...
    public List<UsageBreakdownItem> getItems() {
      return items;
    }
  ...
  public static class ListUsageRecordsOptions {
    ...
    public static class Builder {
      ...
      public ListUsageRecordsOptions build() {
        return new ListUsageRecordsOptions(this);
      }
    }
  }
