 ...
 *
 * <p>Contains detailed information about whether a step or plan execution
...
public final class PolicyEvaluationResult {
    ...
    public PolicyEvaluationResult(
        ...
        this.appliedPolicies = appliedPolicies != null ? Collections.unmodifiableList(appliedPolicies) : Collections.emptyList();
        this.riskScore = riskScore;
        this.requiredActions = requiredActions != null ? Collections.unmodifiableList(requiredActions) : Collections.emptyList();
    ...
    public static final class Builder {
        ...
        public PolicyEvaluationResult build() {
            return new PolicyEvaluationResult(allowed, appliedPolicies, riskScore, requiredActions, processingTimeMs, databaseAccessed);
        }
    }
}
