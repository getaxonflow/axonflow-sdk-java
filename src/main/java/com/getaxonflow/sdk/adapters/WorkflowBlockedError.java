 ...
 *
 * <p>This exception is thrown by {@link LangGraphAdapter#checkGate} when
...
public class WorkflowBlockedError extends RuntimeException {
     ...
     */
    public WorkflowBlockedError(String message, String stepId, String reason, List<String> policyIds) {
        super(message);
        this.stepId = stepId;
        this.reason = reason;
