 ...
 *
 * <p>This adapter provides a simple interface for integrating AxonFlow's Workflow Control Plane
 * with LangGraph workflows. It handles workflow registration, step gate checks, per-tool
 * governance, MCP tool interception, and workflow lifecycle management.
 *
 * <p><strong>Thread safety:</strong> This class is not thread-safe. Each workflow execution should
 * use its own adapter instance from a single thread.
 *
...
public final class LangGraphAdapter implements AutoCloseable {
  ...
  public String startWorkflow(Map<String, Object> metadata, String traceId) {
    CreateWorkflowRequest request =
        new CreateWorkflowRequest(
            workflowName, source, metadata != null ? metadata : Collections.emptyMap(), traceId);
  ...
  public boolean checkGate(String stepName, String stepType, CheckGateOptions options) {
    ...
    StepGateRequest request =
        new StepGateRequest(
            stepName,
            resolvedType,
            options != null && options.getStepInput() != null
                ? options.getStepInput()
  ...
  public void stepCompleted(String stepName, StepCompletedOptions options) {
    ...
    MarkStepCompletedRequest request =
        new MarkStepCompletedRequest(
   ...
   *
   * <p>Convenience wrapper around {@link #checkGate} that creates a {@link ToolContext} and uses
   * step type {@code tool_call}.
   *
  ...
  public boolean checkToolGate(String toolName, String toolType, CheckToolGateOptions options) {
    String stepName =
        (options != null && options.getStepName() != null)
            ? options.getStepName()
            : "tools/" + toolName;

    ToolContext toolContext =
        ToolContext.builder(toolName)
            .toolType(toolType)
            .toolInput(options != null ? options.getToolInput() : null)
            .build();

    CheckGateOptions gateOptions =
   ...
   *
   * <p>The interceptor enforces AxonFlow input and output policies around every MCP tool call.
   *
  ...
  /**
   * Closes the adapter. If the workflow was started but not explicitly completed, aborted, or
   * failed, it will be aborted automatically.
   */
  @Override
  public void close() {
  ...
  public static final class Builder {
    ...
    /**
     * Sets whether to automatically throw on blocked steps. Defaults to {@code true}.
     *
     * <p>When {@code true}, {@link LangGraphAdapter#checkGate} throws {@link WorkflowBlockedError}
     * on block decisions. When {@code false}, it returns {@code false}.
     *
