 ...
 *
 * <p>Bedrock uses AWS IAM authentication (no API keys required). Supports multiple model providers:
 * Anthropic Claude, Amazon Titan, Meta Llama, etc.
 *
 * <h2>Example Usage</h2>
 *
 * <pre>{@code
...
public class BedrockInterceptor {
  ...
  public static class BedrockInvokeRequest {
    ...
    public static BedrockInvokeRequest forClaude(
        String modelId, List<ClaudeMessage> messages, int maxTokens) {
