 ...
 *
 * <p>This interceptor automatically applies policy checks and audit logging to Anthropic API calls
...
public final class AnthropicInterceptor {
  ...
  public static final class AnthropicResponse {
    ...
    public static final class Builder {
      ...
      public Builder content(List<AnthropicContentBlock> content) {
