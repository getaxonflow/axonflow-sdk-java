...
class AxonFlowIntegrationTest {
  ...
  void auditLLMCallShouldRecordAudit() {
        ...
        post(urlEqualTo("/api/audit/llm-call"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{" + "\"success\": true," + "\"audit_id\": \"audit_xyz789\"" + "}")));
    ...
    verify(
        postRequestedFor(urlEqualTo("/api/audit/llm-call"))
  ...
  void proxyLLMCallShouldReturnResponse() {
    ...
    ClientResponse response =
        axonflow.proxyLLMCall(
            ClientRequest.builder().query("What is the weather?").userToken("user-123").build());
  ...
  void shouldHandleAuthenticationError() {
    ...
    assertThatThrownBy(() -> axonflow.proxyLLMCall(ClientRequest.builder().query("test").build()))
  ...
  void generatePlanShouldReturnPlan() {
    ...
    PlanResponse plan =
        axonflow.generatePlan(
            PlanRequest.builder().objective("Research AI governance").domain("generic").build());
  ...
  void queryConnectorShouldReturnResponse() {
    ...
    ConnectorResponse response =
        axonflow.queryConnector(
            ConnectorQuery.builder().connectorId("salesforce").operation("getAccounts").build());
  ...
  void shouldCacheSuccessfulResponses() {
    ...
    ClientRequest request =
        ClientRequest.builder().query("test query").userToken("user-123").build();
