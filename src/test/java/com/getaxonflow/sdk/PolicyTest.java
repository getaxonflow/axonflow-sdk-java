...
/** Tests for Policy CRUD methods. Part of Unified Policy Architecture v2.0.0. */
@WireMockTest
...
class PolicyTest {
  ...
  class StaticPolicies {
    ...
    void listStaticPoliciesWithFiltersShouldIncludeQueryParams() {
      ...
      ListStaticPoliciesOptions options =
    ...
    void getStaticPolicyShouldReturnPolicyById() {
      stubFor(
          get(urlEqualTo("/api/v1/static-policies/pol_123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void createStaticPolicyShouldCreateAndReturnPolicy() {
      ...
      CreateStaticPolicyRequest request =
    ...
    void updateStaticPolicyShouldUpdateAndReturnPolicy() {
      String updatedPolicy =
          SAMPLE_STATIC_POLICY.replace("\"severity\": \"critical\"", "\"severity\": \"high\"");
      stubFor(
          put(urlEqualTo("/api/v1/static-policies/pol_123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      UpdateStaticPolicyRequest request =
          UpdateStaticPolicyRequest.builder().severity(PolicySeverity.HIGH).build();
    ...
    void deleteStaticPolicyShouldDeletePolicy() {
      stubFor(
          delete(urlEqualTo("/api/v1/static-policies/pol_123"))
    ...
    void toggleStaticPolicyShouldToggleEnabledStatus() {
      String toggledPolicy =
          SAMPLE_STATIC_POLICY.replace("\"enabled\": true", "\"enabled\": false");
      stubFor(
          patch(urlEqualTo("/api/v1/static-policies/pol_123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      verify(
          patchRequestedFor(urlEqualTo("/api/v1/static-policies/pol_123"))
    ...
    void testPatternShouldTestPatternAgainstInputs() {
      ...
      stubFor(
          post(urlEqualTo("/api/v1/static-policies/test"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      TestPatternResult result =
          axonflow.testPattern("(?i)select", Arrays.asList("SELECT * FROM users", "Hello world"));
    ...
    void getStaticPolicyVersionsShouldReturnVersionHistory() {
      ...
      stubFor(
          get(urlEqualTo("/api/v1/static-policies/pol_123/versions"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
  ...
  class PolicyOverrides {
    ...
    void createPolicyOverrideShouldCreateOverride() {
      stubFor(
          post(urlEqualTo("/api/v1/static-policies/pol_123/override"))
              .willReturn(
                  aResponse()
                      .withStatus(201)
                      .withHeader("Content-Type", "application/json")
    ...
    void createPolicyOverrideShouldRequireParameters() {
      CreatePolicyOverrideRequest request =
          CreatePolicyOverrideRequest.builder().actionOverride(OverrideAction.WARN).build();
    ...
    void deletePolicyOverrideShouldDeleteOverride() {
      stubFor(
          delete(urlEqualTo("/api/v1/static-policies/pol_123/override"))
              .willReturn(aResponse().withStatus(204)));
  ...
  class DynamicPolicies {
    ...
    void listDynamicPoliciesWithFiltersShouldIncludeQueryParams() {
      ...
      ListDynamicPoliciesOptions options =
          ListDynamicPoliciesOptions.builder().type("cost").enabled(true).build();

      axonflow.listDynamicPolicies(options);

      verify(
          getRequestedFor(urlPathEqualTo("/api/v1/dynamic-policies"))
              .withQueryParam("type", equalTo("cost")));
    }
    ...
    void getDynamicPolicyShouldReturnPolicyById() {
      ...
      stubFor(
          get(urlEqualTo("/api/v1/dynamic-policies/dpol_456"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void createDynamicPolicyShouldCreateAndReturnPolicy() {
      // Agent proxy (Issue #886) returns {"policy": {...}} wrapper
      stubFor(
          post(urlEqualTo("/api/v1/dynamic-policies"))
              .willReturn(
                  aResponse()
                      .withStatus(201)
                      .withHeader("Content-Type", "application/json")
      ...
      CreateDynamicPolicyRequest request =
          CreateDynamicPolicyRequest.builder()
              .name("Rate Limit API")
              .type("cost")
              .conditions(
                  List.of(new DynamicPolicyCondition("requests_per_minute", "greater_than", 100)))
              .actions(
                  List.of(
                      new DynamicPolicyAction("block", Map.of("reason", "Rate limit exceeded"))))
              .priority(50)
              .build();
    ...
    void updateDynamicPolicyShouldUpdateAndReturnPolicy() {
      // Agent proxy (Issue #886) returns {"policy": {...}} wrapper
      stubFor(
          put(urlEqualTo("/api/v1/dynamic-policies/dpol_456"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      UpdateDynamicPolicyRequest request =
          UpdateDynamicPolicyRequest.builder()
              .conditions(
                  List.of(new DynamicPolicyCondition("requests_per_minute", "greater_than", 200)))
              .build();
    ...
    void deleteDynamicPolicyShouldDeletePolicy() {
      stubFor(
          delete(urlEqualTo("/api/v1/dynamic-policies/dpol_456"))
              .willReturn(aResponse().withStatus(204)));
    ...
    void toggleDynamicPolicyShouldToggleEnabledStatus() {
      ...
      String toggledPolicy =
          SAMPLE_DYNAMIC_POLICY.replace("\"enabled\": true", "\"enabled\": false");
      stubFor(
          put(urlEqualTo("/api/v1/dynamic-policies/dpol_456"))
              .willReturn(
                  aResponse()
      ...
      verify(
          putRequestedFor(urlEqualTo("/api/v1/dynamic-policies/dpol_456"))
              .withRequestBody(containing("\"enabled\":false")));
    }
    ...
    void getEffectiveDynamicPoliciesShouldReturnEffectivePolicies() {
      // Agent proxy (Issue #886) returns {"policies": [...]} wrapper
      stubFor(
          get(urlPathEqualTo("/api/v1/dynamic-policies/effective"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
