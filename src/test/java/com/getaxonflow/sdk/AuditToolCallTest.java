...
class AuditToolCallTest {
    ...
    void shouldAuditToolCallWithAllFields() {
        stubFor(post(urlEqualTo("/api/v1/audit/tool-call"))
            .willReturn(aResponse()
                .withStatus(201)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"audit_id\":\"aud_tc_001\",\"status\":\"recorded\",\"timestamp\":\"2026-03-14T12:00:00Z\"}")));
        ...
        verify(postRequestedFor(urlEqualTo("/api/v1/audit/tool-call"))
    ...
    void shouldAuditToolCallWithRequiredFieldsOnly() {
        stubFor(post(urlEqualTo("/api/v1/audit/tool-call"))
            .willReturn(aResponse()
                .withStatus(201)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"audit_id\":\"aud_tc_002\",\"status\":\"recorded\",\"timestamp\":\"2026-03-14T12:01:00Z\"}")));
    ...
    void auditToolCallAsyncShouldReturnFuture() throws Exception {
        stubFor(post(urlEqualTo("/api/v1/audit/tool-call"))
            .willReturn(aResponse()
                .withStatus(201)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"audit_id\":\"aud_tc_async\",\"status\":\"recorded\",\"timestamp\":\"2026-03-14T12:02:00Z\"}")));
    ...
    void requestShouldHaveCorrectEqualsAndHashCode() {
        AuditToolCallRequest req1 = AuditToolCallRequest.builder()
            .toolName("tool_a").toolType("function").build();
        AuditToolCallRequest req2 = AuditToolCallRequest.builder()
            .toolName("tool_a").toolType("function").build();
        AuditToolCallRequest req3 = AuditToolCallRequest.builder()
            .toolName("tool_b").build();
    ...
    void requestToStringShouldIncludeKeyFields() {
        AuditToolCallRequest request = AuditToolCallRequest.builder()
            .toolName("my_tool").toolType("api").workflowId("wf_1").build();
    ...
    void responseToStringShouldIncludeKeyFields() {
        AuditToolCallResponse response = new AuditToolCallResponse("aud_1", "recorded", "2026-01-01T00:00:00Z");
