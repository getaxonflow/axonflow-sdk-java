...
class WCPApprovalTypesTest {
  ...
  void approveStepResponseShouldIgnoreUnknownProperties() throws Exception {
    String json =
        "{\"workflow_id\":\"wf-1\",\"step_id\":\"s-1\",\"status\":\"approved\",\"extra\":\"field\"}";
  ...
  void pendingApprovalEqualsAndHashCode() {
    PendingApproval a1 =
        new PendingApproval("wf-1", "Name", "s-1", "Step", "llm_call", "2026-02-07T10:00:00Z");
    PendingApproval a2 =
        new PendingApproval("wf-1", "Name", "s-1", "Step", "llm_call", "2026-02-07T10:00:00Z");
    PendingApproval a3 =
        new PendingApproval("wf-2", "Name", "s-1", "Step", "llm_call", "2026-02-07T10:00:00Z");
  ...
  void pendingApprovalsResponseListShouldBeImmutable() {
    PendingApproval approval =
        new PendingApproval("wf-1", "Name", "s-1", "Step", "llm_call", "2026-02-07T10:00:00Z");
    PendingApprovalsResponse response = new PendingApprovalsResponse(Arrays.asList(approval), 1);
  ...
  void pendingApprovalsResponseEqualsAndHashCode() {
    PendingApproval approval =
        new PendingApproval("wf-1", "Name", "s-1", "Step", "llm_call", "2026-02-07T10:00:00Z");
    PendingApprovalsResponse r1 =
        new PendingApprovalsResponse(Collections.singletonList(approval), 1);
    PendingApprovalsResponse r2 =
        new PendingApprovalsResponse(Collections.singletonList(approval), 1);
