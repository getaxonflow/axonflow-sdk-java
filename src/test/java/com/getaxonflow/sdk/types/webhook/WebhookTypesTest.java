...
class WebhookTypesTest {
    ...
    void createWebhookRequestShouldDeserialize() throws Exception {
        String json = "{\"url\":\"https://example.com/hook\",\"events\":[\"step.blocked\"],"
    ...
    void createWebhookRequestEqualsAndHashCode() {
        CreateWebhookRequest r1 = CreateWebhookRequest.builder()
            .url("https://example.com").events(Arrays.asList("e1")).secret("s").active(true).build();
        CreateWebhookRequest r2 = CreateWebhookRequest.builder()
            .url("https://example.com").events(Arrays.asList("e1")).secret("s").active(true).build();
        CreateWebhookRequest r3 = CreateWebhookRequest.builder()
            .url("https://other.com").events(Arrays.asList("e1")).secret("s").active(true).build();
    ...
    void webhookSubscriptionShouldConstructWithAllFields() {
        WebhookSubscription subscription = new WebhookSubscription(
            "wh-123", "https://example.com/hook",
            Arrays.asList("step.blocked"), true,
            "2026-02-07T10:00:00Z", "2026-02-07T11:00:00Z");
    ...
    void webhookSubscriptionShouldHandleNullEvents() {
        WebhookSubscription subscription = new WebhookSubscription(
            "wh-1", "https://example.com", null, true, null, null);
    ...
    void webhookSubscriptionEqualsAndHashCode() {
        WebhookSubscription s1 = new WebhookSubscription(
    ...
    void webhookSubscriptionShouldIgnoreUnknownProperties() throws Exception {
        String json = "{\"id\":\"wh-1\",\"url\":\"https://example.com\","
    ...
    void updateWebhookRequestEqualsAndHashCode() {
        UpdateWebhookRequest r1 = UpdateWebhookRequest.builder()
            .url("https://a.com").active(true).build();
        UpdateWebhookRequest r2 = UpdateWebhookRequest.builder()
            .url("https://a.com").active(true).build();
        UpdateWebhookRequest r3 = UpdateWebhookRequest.builder()
            .url("https://b.com").active(true).build();
    ...
    void updateWebhookRequestToStringShouldContainFields() {
        UpdateWebhookRequest request = UpdateWebhookRequest.builder()
            .url("https://example.com").active(true).build();
        String str = request.toString();
    ...
    void listWebhooksResponseListShouldBeImmutable() {
        ...
        assertThatThrownBy(() -> response.getWebhooks().add(
            new WebhookSubscription("wh-2", "url", null, true, null, null)))
            .isInstanceOf(UnsupportedOperationException.class);
    }
