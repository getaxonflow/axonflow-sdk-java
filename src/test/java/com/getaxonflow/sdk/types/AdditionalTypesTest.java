...
class AdditionalTypesTest {
  ...
  class PolicyInfoTests {
    ...
    void testPolicyInfoEqualsHashCode() {
      PolicyInfo info1 =
          new PolicyInfo(List.of("policy1"), List.of("check1"), "10ms", "tenant1", 0.5, null);

      PolicyInfo info2 =
          new PolicyInfo(List.of("policy1"), List.of("check1"), "10ms", "tenant1", 0.5, null);

      PolicyInfo info3 =
          new PolicyInfo(List.of("policy2"), List.of("check1"), "10ms", "tenant1", 0.5, null);
  ...
  class HealthStatusTests {
    ...
    void testHealthStatusCreation() {
      ...
      HealthStatus status = new HealthStatus("healthy", "1.0.0", "24h30m", components, null, null);
  ...
  class ConnectorResponseTests {
    ...
    void testConnectorResponseCreation() {
      ...
      ConnectorResponse response =
          new ConnectorResponse(true, data, null, "connector-123", "query", "15.5ms");
    ...
    void testConnectorResponseError() {
      ConnectorResponse response =
          new ConnectorResponse(
              false, null, "Connection failed", "connector-456", "install", "0ms");
    ...
    void testConnectorResponseEqualsHashCode() {
      ConnectorResponse response1 = new ConnectorResponse(true, null, null, "conn1", "query", null);
      ConnectorResponse response2 = new ConnectorResponse(true, null, null, "conn1", "query", null);
      ConnectorResponse response3 =
          new ConnectorResponse(false, null, null, "conn1", "query", null);
    ...
    void testConnectorResponseToString() {
      ConnectorResponse response =
          new ConnectorResponse(true, null, null, "conn-123", "query", null);
  ...
  class ConnectorInfoTests {
    ...
    void testConnectorInfoNullCollections() {
      ConnectorInfo info =
          new ConnectorInfo("id", "name", "desc", "type", "1.0", null, null, null, null);
    ...
    void testConnectorInfoEqualsHashCode() {
      ...
      ConnectorInfo info2 =
          new ConnectorInfo("id", "name", "desc", "type", "1.0", null, null, null, null);
      ConnectorInfo info3 =
          new ConnectorInfo("id2", "name", "desc", "type", "1.0", null, null, null, null);
    ...
    void testConnectorInfoToString() {
      ConnectorInfo info =
          new ConnectorInfo("conn-123", "GitHub", "desc", "github", "1.0", null, null, true, false);
  ...
  class ConnectorQueryTests {
    ...
    void testConnectorQueryBuilderRequiresConnectorId() {
      assertThatThrownBy(() -> ConnectorQuery.builder().operation("list").build())
    ...
    void testConnectorQueryBuilderRequiresOperation() {
      assertThatThrownBy(() -> ConnectorQuery.builder().connectorId("conn-123").build())
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void testConnectorQueryEqualsHashCode() {
      ConnectorQuery query1 =
          ConnectorQuery.builder().connectorId("conn-1").operation("op").build();
      ConnectorQuery query2 =
          ConnectorQuery.builder().connectorId("conn-1").operation("op").build();
      ConnectorQuery query3 =
          ConnectorQuery.builder().connectorId("conn-2").operation("op").build();
  ...
  class AuditResultTests {
    ...
    void testAuditResultCreation() {
      AuditResult result = new AuditResult(true, "audit-123", "Audit recorded successfully", null);
    ...
    void testAuditResultError() {
      AuditResult result = new AuditResult(false, null, null, "Audit failed");
