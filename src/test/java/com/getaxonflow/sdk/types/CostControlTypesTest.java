...
class CostControlTypesTest {
    ...
    class ListBudgetsOptionsTests {
        ...
        void builderShouldCreateOptions() {
            ListBudgetsOptions options = ListBudgetsOptions.builder()
    ...
    class ListUsageRecordsOptionsTests {
        ...
        @DisplayName("builder should create options with all fields")
        void builderShouldCreateOptions() {
            ListUsageRecordsOptions options = ListUsageRecordsOptions.builder()
                .limit(50)
                .offset(100)
                .provider("openai")
                .model("gpt-4")
    ...
    class BudgetTests {
        ...
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"id\":\"budget-123\",\"name\":\"Monthly Budget\",\"scope\":\"organization\"," +
    ...
    class BudgetStatusTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"budget\":{\"id\":\"budget-123\"},\"used_usd\":500.0,\"remaining_usd\":500.0," +
    ...
    class BudgetAlertTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"id\":\"alert-123\",\"budget_id\":\"budget-456\",\"alert_type\":\"threshold\"," +
    ...
    class BudgetDecisionTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"allowed\":true,\"action\":\"allow\",\"message\":\"Within budget\"," +
                "\"budgets\":[{\"id\":\"budget-1\"}]}";
    ...
    class UsageSummaryTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"total_cost_usd\":150.75,\"total_requests\":5000,\"total_tokens_in\":1000000," +
    ...
    class UsageBreakdownItemTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"group_value\":\"openai\",\"cost_usd\":100.0,\"percentage\":66.7," +
    ...
    class UsageBreakdownTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"group_by\":\"provider\",\"total_cost_usd\":150.0," +
    ...
    class UsageRecordTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"id\":\"record-123\",\"provider\":\"openai\",\"model\":\"gpt-4\"," +
    ...
    class PricingInfoTests {
        ...
        @DisplayName("should deserialize from JSON")
        void shouldDeserializeFromJson() throws Exception {
            String json = "{\"provider\":\"openai\",\"model\":\"gpt-4\"," +
