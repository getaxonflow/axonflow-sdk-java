...
class ExecutionTypesTest {
    ...
    void testExecutionStatusValueIsTerminal(ExecutionStatusValue status) {
        boolean expected = status == ExecutionStatusValue.COMPLETED ||
    ...
    void testStepStatusValueIsTerminal(StepStatusValue status) {
        boolean expected = status == StepStatusValue.COMPLETED ||
    ...
    void testStepStatusValueIsBlocking(StepStatusValue status) {
        boolean expected = status == StepStatusValue.BLOCKED ||
                           status == StepStatusValue.APPROVAL;
    ...
    void testUnifiedGateDecisionFromValue() {
        ...
        assertEquals(UnifiedGateDecision.REQUIRE_APPROVAL, UnifiedGateDecision.fromValue("require_approval"));
    }
    ...
    void testUnifiedStepStatusBuilder() {
        ...
        UnifiedStepStatus step = UnifiedStepStatus.builder()
                .stepId("step-1")
                .stepIndex(0)
                .stepName("Test Step")
    ...
    void testUnifiedStepStatusEqualsHashCode() {
        UnifiedStepStatus step1 = UnifiedStepStatus.builder()
                .stepId("step-1")
                .stepIndex(0)
                .build();
        UnifiedStepStatus step2 = UnifiedStepStatus.builder()
                .stepId("step-1")
                .stepIndex(0)
                .build();
        UnifiedStepStatus step3 = UnifiedStepStatus.builder()
                .stepId("step-2")
                .stepIndex(1)
                .build();
    ...
    void testExecutionStatusBuilder() {
        Instant now = Instant.now();
        List<UnifiedStepStatus> steps = Arrays.asList(
    ...
    void testExecutionStatusIsTerminal() {
        ExecutionStatus running = ExecutionStatus.builder()
                .executionId("exec-1")
                .status(ExecutionStatusValue.RUNNING)
                .build();
        ExecutionStatus completed = ExecutionStatus.builder()
                .executionId("exec-2")
    ...
    void testExecutionStatusIsMapPlan() {
        ExecutionStatus map = ExecutionStatus.builder()
                .executionId("exec-1")
                .executionType(ExecutionType.MAP_PLAN)
                .build();
        ExecutionStatus wcp = ExecutionStatus.builder()
                .executionId("exec-2")
    ...
    void testExecutionStatusEqualsHashCode() {
        ExecutionStatus status1 = ExecutionStatus.builder()
                .executionId("exec-1")
                .build();
        ExecutionStatus status2 = ExecutionStatus.builder()
                .executionId("exec-1")
                .build();
        ExecutionStatus status3 = ExecutionStatus.builder()
                .executionId("exec-2")
                .build();
    ...
    void testUnifiedListExecutionsRequestBuilder() {
        UnifiedListExecutionsRequest request = UnifiedListExecutionsRequest.builder()
                .executionType(ExecutionType.MAP_PLAN)
                .status(ExecutionStatusValue.RUNNING)
                .tenantId("tenant-1")
                .orgId("org-1")
    ...
    void testUnifiedListExecutionsResponse() {
        List<ExecutionStatus> executions = Arrays.asList(
                ExecutionStatus.builder().executionId("exec-1").build(),
                ExecutionStatus.builder().executionId("exec-2").build()
        );

        UnifiedListExecutionsResponse response = new UnifiedListExecutionsResponse(
                executions, 100, 50, 0, true
        );
