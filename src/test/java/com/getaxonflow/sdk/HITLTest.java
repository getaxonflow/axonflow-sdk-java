...
class HITLTest {
    ...
    class ListHITLQueue {
        ...
        void shouldReturnApprovalRequests() {
            stubFor(get(urlPathEqualTo("/api/v1/hitl/queue"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true, \"data\": [" +
                        SAMPLE_APPROVAL_REQUEST + "," + SAMPLE_APPROVAL_REQUEST_2 +
        ...
        void shouldReturnEmptyList() {
            stubFor(get(urlPathEqualTo("/api/v1/hitl/queue"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true, \"data\": [], \"meta\": {\"total\": 0, \"has_more\": false}}")));
        ...
        void shouldIncludeQueryParams() {
            stubFor(get(urlPathEqualTo("/api/v1/hitl/queue"))
                ...
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true, \"data\": [" + SAMPLE_APPROVAL_REQUEST_2 +
        ...
        void shouldHandleHasMore() {
            ...
            HITLQueueListResponse result = axonflow.listHITLQueue(
                HITLQueueListOptions.builder().limit(1).build());
    ...
    class GetHITLRequest {
        ...
        void shouldReturnRequestById() {
            stubFor(get(urlEqualTo("/api/v1/hitl/queue/hitl_req_001"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true, \"data\": " + SAMPLE_APPROVAL_REQUEST + "}")));
            ...
            assertThat(result.getTriggerReason()).isEqualTo("Transaction amount exceeds $10,000 threshold");
        ...
        void shouldThrowOnNotFound() {
            stubFor(get(urlEqualTo("/api/v1/hitl/queue/nonexistent"))
                .willReturn(aResponse()
                    .withStatus(404)
                    .withHeader("Content-Type", "application/json")
    ...
    class ApproveHITLRequest {
        ...
        void shouldSendApproveRequest() {
            stubFor(post(urlEqualTo("/api/v1/hitl/queue/hitl_req_001/approve"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true}")));

            HITLReviewInput review = HITLReviewInput.builder()
            ...
            verify(postRequestedFor(urlEqualTo("/api/v1/hitl/queue/hitl_req_001/approve"))
    ...
    class RejectHITLRequest {
        ...
        void shouldSendRejectRequest() {
            stubFor(post(urlEqualTo("/api/v1/hitl/queue/hitl_req_001/reject"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true}")));
            ...
            verify(postRequestedFor(urlEqualTo("/api/v1/hitl/queue/hitl_req_001/reject"))
                .withHeader("Content-Type", containing("application/json"))
                .withRequestBody(containing("\"reviewer_id\":\"reviewer_002\""))
                .withRequestBody(containing("\"reviewer_email\":\"admin@example.com\""))
                .withRequestBody(containing("\"comment\":\"Rejected: suspicious transaction pattern\"")));
        }
    ...
    class GetHITLStats {
        ...
        void shouldReturnParsedStats() {
            stubFor(get(urlEqualTo("/api/v1/hitl/stats"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"success\": true, \"data\": {" +
