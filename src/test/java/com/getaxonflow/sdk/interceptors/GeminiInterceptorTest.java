...
class GeminiInterceptorTest {
  ...
  class IntegrationTests {
    ...
    void testWrapAllowedRequest() {
      ...
      Function<GeminiRequest, GeminiResponse> mockCall =
          request -> {
            GeminiResponse response = new GeminiResponse();
            Candidate candidate = new Candidate();
    ...
    void testWrapAsyncAllowedRequest() throws Exception {
      ...
      Function<GeminiRequest, CompletableFuture<GeminiResponse>> mockCall =
          request -> {
            GeminiResponse response = new GeminiResponse();
            Candidate candidate = new Candidate();
      ...
      GeminiResponse response = interceptor.wrapAsync(mockCall).apply(request).get();
    ...
    void testWrapAsyncBlockedRequest() {
      ...
      try {
        CompletableFuture<GeminiResponse> future = interceptor.wrapAsync(mockCall).apply(request);
