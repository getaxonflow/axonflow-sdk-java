...
class AnthropicInterceptorTest {
  ...
  class TypeTests {
    ...
    void testAnthropicRequestRequiresModel() {
      assertThatThrownBy(
              () -> AnthropicRequest.builder().maxTokens(1024).addUserMessage("Test").build())
    ...
    void testAnthropicResponseGetSummaryEmpty() {
      AnthropicResponse response = AnthropicResponse.builder().content(List.of()).build();
  ...
  class IntegrationTests {
    ...
    void testWrapAllowedRequest() {
      ...
      Function<AnthropicRequest, AnthropicResponse> mockCall =
          request ->
              AnthropicResponse.builder()
                  .id("msg-123")
                  .model("claude-3-sonnet-20240229")
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":false,\"blocked\":true,\"block_reason\":\"Request blocked by policy: content-filter\"}")));
    ...
    void testWrapAsyncAllowedRequest() throws Exception {
      ...
      AnthropicResponse response = interceptor.wrapAsync(mockCall).apply(request).get();
    ...
    void testWrapAsyncBlockedRequest() {
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":false,\"blocked\":true,\"block_reason\":\"Policy violation detected\"}")));
      ...
      // Execute wrapped async call
      CompletableFuture<AnthropicResponse> future = interceptor.wrapAsync(mockCall).apply(request);
    ...
    void testStaticWrapperMethod() {
      ...
      Function<AnthropicRequest, AnthropicResponse> mockCall =
          request ->
              AnthropicResponse.builder().id("msg-789").model("claude-3-haiku-20240307").build();
      ...
      AnthropicResponse response =
          AnthropicInterceptor.wrapMessage(axonflow, "user-token", mockCall).apply(request);
