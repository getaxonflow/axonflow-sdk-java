...
class BedrockInterceptorTest {
  ...
  class TypeTests {
    ...
    void testModelIdConstants() {
      assertThat(BedrockInterceptor.CLAUDE_3_OPUS)
          .isEqualTo("anthropic.claude-3-opus-20240229-v1:0");
      assertThat(BedrockInterceptor.CLAUDE_3_SONNET)
          .isEqualTo("anthropic.claude-3-sonnet-20240229-v1:0");
      assertThat(BedrockInterceptor.CLAUDE_3_HAIKU)
    ...
    void testBedrockInvokeRequestForClaude() {
      List<ClaudeMessage> messages =
          List.of(ClaudeMessage.user("Hello"), ClaudeMessage.assistant("Hi there!"));

      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(BedrockInterceptor.CLAUDE_3_SONNET, messages, 1024);
    ...
    void testBedrockInvokeRequestForTitan() {
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forTitan(
              BedrockInterceptor.TITAN_TEXT_EXPRESS, "Generate some text");
    ...
    void testBedrockInvokeRequestExtractPromptClaude() {
      List<ClaudeMessage> messages =
          List.of(ClaudeMessage.user("First message"), ClaudeMessage.user("Second message"));

      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(BedrockInterceptor.CLAUDE_3_HAIKU, messages, 500);
    ...
    void testBedrockInvokeRequestExtractPromptTitan() {
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forTitan(BedrockInterceptor.TITAN_TEXT_LITE, "Titan prompt");
  ...
  class IntegrationTests {
    ...
    void testWrapAllowedRequest() {
      ...
      // Stub audit call
      stubFor(
          post(urlEqualTo("/api/audit"))
              .willReturn(aResponse().withStatus(200).withBody("{\"success\":true}")));

      // Create mock Bedrock call
      Function<BedrockInvokeRequest, BedrockInvokeResponse> mockCall =
          request -> {
            BedrockInvokeResponse response = new BedrockInvokeResponse();
      ...
      // Create request
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(
              BedrockInterceptor.CLAUDE_3_SONNET, List.of(ClaudeMessage.user("Hello!")), 1024);
    ...
    void testWrapBlockedRequest() {
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":false,\"blocked\":true,\"block_reason\":\"Policy violation: no-pii\"}")));
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forTitan(BedrockInterceptor.TITAN_TEXT_EXPRESS, "Blocked content");
    ...
    void testWrapWithTitanModel() {
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":true,\"blocked\":false,\"plan_id\":\"plan-titan\"}")));
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forTitan(BedrockInterceptor.TITAN_TEXT_EXPRESS, "Hello Titan");
    ...
    void testWrapAsyncAllowedRequest() throws Exception {
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":true,\"blocked\":false,\"plan_id\":\"plan-async\"}")));
      ...
      Function<BedrockInvokeRequest, CompletableFuture<BedrockInvokeResponse>> mockCall =
          request -> {
            BedrockInvokeResponse response = new BedrockInvokeResponse();
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(
              BedrockInterceptor.CLAUDE_3_HAIKU, List.of(ClaudeMessage.user("Async test")), 512);

      BedrockInvokeResponse response = interceptor.wrapAsync(mockCall).apply(request).get();
    ...
    void testWrapAsyncBlockedRequest() {
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":false,\"blocked\":true,\"block_reason\":\"Async policy violation\"}")));
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(
              BedrockInterceptor.CLAUDE_3_OPUS, List.of(ClaudeMessage.user("Blocked async")), 1024);

      // Execute wrapped async call - should return failed future or throw
      try {
        CompletableFuture<BedrockInvokeResponse> future =
            interceptor.wrapAsync(mockCall).apply(request);
    ...
    void testWrapNullResponse() {
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forTitan(BedrockInterceptor.TITAN_TEXT_LITE, "Test");
    ...
    void testWrapLongResponseSummary() {
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(
              BedrockInterceptor.CLAUDE_2, List.of(ClaudeMessage.user("Test")), 100);
    ...
    void testWrapWithLlamaModel() {
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":true,\"blocked\":false,\"plan_id\":\"plan-llama\"}")));
      ...
      BedrockInvokeRequest request =
          BedrockInvokeRequest.forClaude(
              BedrockInterceptor.LLAMA3_70B, List.of(ClaudeMessage.user("Hello Llama")), 1024);
