...
class OllamaInterceptorTest {
  ...
  class IntegrationTests {
    ...
    void testWrapChatAllowedRequest() {
      ...
      Function<OllamaChatRequest, OllamaChatResponse> mockCall =
          request -> {
            OllamaChatResponse response = new OllamaChatResponse();
            response.setModel("llama2");
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":false,\"blocked\":true,\"block_reason\":\"Policy violation\"}")));
    ...
    void testWrapGenerateAllowedRequest() {
      ...
      Function<OllamaGenerateRequest, OllamaGenerateResponse> mockCall =
          request -> {
            OllamaGenerateResponse response = new OllamaGenerateResponse();
            response.setModel("llama2");
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":false,\"blocked\":true,\"block_reason\":\"Content blocked\"}")));
    ...
    void testWrapChatAsyncAllowedRequest() throws Exception {
      ...
      Function<OllamaChatRequest, CompletableFuture<OllamaChatResponse>> mockCall =
          request -> {
            OllamaChatResponse response = new OllamaChatResponse();
            response.setModel("llama2");
      ...
      OllamaChatResponse response = interceptor.wrapChatAsync(mockCall).apply(request).get();
    ...
    void testWrapChatAsyncBlockedRequest() {
      ...
      try {
        CompletableFuture<OllamaChatResponse> future =
            interceptor.wrapChatAsync(mockCall).apply(request);
          ...
          post(urlEqualTo("/api/request"))
              .willReturn(
                  aResponse()
                      ...
                      .withHeader("Content-Type", "application/json")
                      .withBody(
                          "{\"success\":true,\"blocked\":false,\"plan_id\":\"plan-long-gen\"}")));
