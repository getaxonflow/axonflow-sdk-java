...
class AuditReadTest {
    ...
    class SearchAuditLogs {
        ...
        void searchAuditLogsWithAllFilters() {
            stubFor(post(urlEqualTo("/api/v1/audit/search"))
            ...
            verify(postRequestedFor(urlEqualTo("/api/v1/audit/search"))
        ...
        void searchAuditLogsWithWrappedResponse() {
            stubFor(post(urlEqualTo("/api/v1/audit/search"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"entries\": [" + SAMPLE_AUDIT_ENTRY_1 + "], \"total\": 100, \"limit\": 10, \"offset\": 0}")));
        ...
        void searchAuditLogsWithBadRequest() {
            ...
            assertThatThrownBy(() -> axonflow.searchAuditLogs())
    ...
    class GetAuditLogsByTenant {
        ...
        void getAuditLogsByTenantWithDefaults() {
            stubFor(get(urlPathEqualTo("/api/v1/audit/tenant/tenant-abc"))
        ...
        void getAuditLogsByTenantWithCapLimit() {
            ...
            verify(getRequestedFor(urlPathEqualTo("/api/v1/audit/tenant/tenant-abc"))
                .withQueryParam("limit", equalTo("1000")));
        }
        ...
        void getAuditLogsByTenantWithWrappedResponse() {
            stubFor(get(urlPathEqualTo("/api/v1/audit/tenant/tenant-abc"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"entries\": [" + SAMPLE_AUDIT_ENTRY_1 + "], \"total\": 50, \"limit\": 50, \"offset\": 0}")));
        ...
        void getAuditLogsByTenantWithNotFound() {
            stubFor(get(urlPathEqualTo("/api/v1/audit/tenant/nonexistent"))
                .willReturn(aResponse()
                    .withStatus(404)
                    .withHeader("Content-Type", "application/json")
        ...
        void getAuditLogsByTenantWithForbidden() {
            stubFor(get(urlPathEqualTo("/api/v1/audit/tenant/other-tenant"))
                .willReturn(aResponse()
                    .withStatus(403)
                    .withHeader("Content-Type", "application/json")
        ...
        void getAuditLogsByTenantWithUrlEncoding() {
            stubFor(get(urlPathEqualTo("/api/v1/audit/tenant/tenant%2Fwith%2Fslashes"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("[]")));
        ...
        void getAuditLogsByTenantAsync() throws Exception {
            ...
            CompletableFuture<AuditSearchResponse> future = axonflow.getAuditLogsByTenantAsync("tenant-abc", null);
            AuditSearchResponse response = future.get();
        ...
        void handleMissingOptionalFields() {
            stubFor(post(urlEqualTo("/api/v1/audit/search"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("[{\"id\": \"audit-minimal\", \"timestamp\": \"2026-01-05T10:00:00Z\"}]")));
        ...
        void auditSearchResponseHasMoreFalse() {
            stubFor(post(urlEqualTo("/api/v1/audit/search"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody("{\"entries\": [" + SAMPLE_AUDIT_ENTRY_1 + "], \"total\": 1, \"limit\": 10, \"offset\": 0}")));
