...
class MASFEATTypesTest {
    ...
    class MaterialityClassificationTests {
        ...
        void testFromValue() {
            assertThat(MaterialityClassification.fromValue("high")).isEqualTo(MaterialityClassification.HIGH);
            assertThat(MaterialityClassification.fromValue("medium")).isEqualTo(MaterialityClassification.MEDIUM);
            assertThat(MaterialityClassification.fromValue("low")).isEqualTo(MaterialityClassification.LOW);
        }
    ...
    class FEATAssessmentStatusTests {
        ...
        void testFromValue() {
            ...
            assertThat(FEATAssessmentStatus.fromValue("in_progress")).isEqualTo(FEATAssessmentStatus.IN_PROGRESS);
            assertThat(FEATAssessmentStatus.fromValue("completed")).isEqualTo(FEATAssessmentStatus.COMPLETED);
            assertThat(FEATAssessmentStatus.fromValue("approved")).isEqualTo(FEATAssessmentStatus.APPROVED);
            assertThat(FEATAssessmentStatus.fromValue("rejected")).isEqualTo(FEATAssessmentStatus.REJECTED);
        }
    ...
    class AISystemUseCaseTests {
        ...
        void testEnumValues() {
            ...
            assertThat(AISystemUseCase.INSURANCE_UNDERWRITING.getValue()).isEqualTo("insurance_underwriting");
        ...
        @DisplayName("Should convert from string value")
        void testFromValue() {
            assertThat(AISystemUseCase.fromValue("credit_scoring")).isEqualTo(AISystemUseCase.CREDIT_SCORING);
            assertThat(AISystemUseCase.fromValue("robo_advisory")).isEqualTo(AISystemUseCase.ROBO_ADVISORY);
            assertThat(AISystemUseCase.fromValue("fraud_detection")).isEqualTo(AISystemUseCase.FRAUD_DETECTION);
    ...
    class RegistrySummaryTests {
        ...
        @DisplayName("Should set and get all fields")
        void testSettersAndGetters() {
            Map<String, Integer> byUseCase = Map.of(
                "credit_scoring", 4,
                "fraud_detection", 6
            );
