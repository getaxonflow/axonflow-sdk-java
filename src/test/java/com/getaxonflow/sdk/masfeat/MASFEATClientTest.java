    ...
    void testRegisterSystem() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/registry"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
    ...
    void testGetSystem() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          get(urlEqualTo("/api/v1/masfeat/registry/sys-123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testActivateSystem() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          put(urlEqualTo("/api/v1/masfeat/registry/sys-123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testCreateAssessment() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/assessments"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      CreateAssessmentRequest request =
          CreateAssessmentRequest.builder().systemId("sys-789").assessmentType("annual").build();
    ...
    void testGetAssessment() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          get(urlEqualTo("/api/v1/masfeat/assessments/assess-123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testUpdateAssessment() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          put(urlEqualTo("/api/v1/masfeat/assessments/assess-123"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      UpdateAssessmentRequest request = UpdateAssessmentRequest.builder().fairnessScore(85).build();
    ...
    void testSubmitAssessment() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/assessments/assess-123/submit"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testApproveAssessment() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/assessments/assess-123/approve"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testGetKillSwitch() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          get(urlEqualTo("/api/v1/masfeat/killswitch/sys-789"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testConfigureKillSwitch() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/killswitch/sys-789/configure"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testTriggerKillSwitch() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/killswitch/sys-789/trigger"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
      ...
      TriggerKillSwitchRequest request =
          TriggerKillSwitchRequest.builder().reason("Manual trigger").build();
    ...
    void testRestoreKillSwitch() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          post(urlEqualTo("/api/v1/masfeat/killswitch/sys-789/restore"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
    ...
    void testGetKillSwitchHistory() {
      String responseJson =
          "{"
              ...
              + "}";
      stubFor(
          get(urlEqualTo("/api/v1/masfeat/killswitch/sys-789/history?limit=10"))
              .willReturn(
                  aResponse()
                      .withStatus(200)
                      .withHeader("Content-Type", "application/json")
