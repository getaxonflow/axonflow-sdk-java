...
class PolicySimulationTest {
    ...
    void shouldSimulatePoliciesBlocked() {
        stubFor(post(urlEqualTo("/api/v1/policies/simulate"))
    ...
    void shouldSimulatePoliciesWithContext() {
        stubFor(post(urlEqualTo("/api/v1/policies/simulate"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"success\":true,\"data\":{\"allowed\":false,\"applied_policies\":[\"geo-block\"],\"risk_score\":0.9,\"required_actions\":[],\"processing_time_ms\":8,\"total_policies\":3,\"dry_run\":true,\"simulated_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"enterprise\"}}")));
    ...
    void simulatePoliciesAsyncShouldReturnFuture() throws Exception {
        stubFor(post(urlEqualTo("/api/v1/policies/simulate"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"success\":true,\"data\":{\"allowed\":true,\"applied_policies\":[],\"risk_score\":0.0,\"required_actions\":[],\"processing_time_ms\":3,\"total_policies\":2,\"dry_run\":true,\"simulated_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"evaluation\"}}")));

        CompletableFuture<SimulatePoliciesResponse> future = axonflow.simulatePoliciesAsync(
            SimulatePoliciesRequest.builder().query("Hello").build());
    ...
    void shouldHandleServerErrorOnSimulate() {
        ...
        assertThatThrownBy(() -> axonflow.simulatePolicies(
            SimulatePoliciesRequest.builder().query("test").build()))
    ...
    void shouldHandleUnwrappedResponseForSimulate() {
        stubFor(post(urlEqualTo("/api/v1/policies/simulate"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"allowed\":true,\"applied_policies\":[],\"risk_score\":0.0,\"required_actions\":[],\"processing_time_ms\":2,\"total_policies\":1,\"dry_run\":true,\"simulated_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"evaluation\"}")));
    ...
    void shouldGetPolicyImpactReport() {
        stubFor(post(urlEqualTo("/api/v1/policies/impact-report"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
        ...
        verify(postRequestedFor(urlEqualTo("/api/v1/policies/impact-report"))
    ...
    void shouldRejectNullPolicyIdInImpactReportBuilder() {
        assertThatThrownBy(() -> ImpactReportRequest.builder()
    ...
    void getPolicyImpactReportAsyncShouldReturnFuture() throws Exception {
        stubFor(post(urlEqualTo("/api/v1/policies/impact-report"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"success\":true,\"data\":{\"policy_id\":\"p1\",\"total_inputs\":1,\"matched\":0,\"blocked\":0,\"match_rate\":0.0,\"block_rate\":0.0,\"results\":[],\"processing_time_ms\":2,\"generated_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"evaluation\"}}")));

        CompletableFuture<ImpactReportResponse> future = axonflow.getPolicyImpactReportAsync(
            ImpactReportRequest.builder()
                .policyId("p1")
                .inputs(List.of(ImpactReportInput.builder().query("test").build()))
                .build());
    ...
    void shouldHandleServerErrorOnImpactReport() {
        ...
        assertThatThrownBy(() -> axonflow.getPolicyImpactReport(
            ImpactReportRequest.builder()
                .policyId("p1")
                .inputs(List.of(ImpactReportInput.builder().query("test").build()))
                .build()))
    ...
    void shouldDetectNoConflicts() {
        stubFor(post(urlEqualTo("/api/v1/policies/conflicts"))
            ...
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"success\":true,\"data\":{\"conflicts\":[],\"total_policies\":5,\"conflict_count\":0,\"checked_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"enterprise\"}}")));
    ...
    void detectPolicyConflictsAsyncShouldReturnFuture() throws Exception {
        ...
        CompletableFuture<PolicyConflictResponse> future = axonflow.detectPolicyConflictsAsync("async_policy");
    ...
    void shouldHandleUnwrappedResponseForConflicts() {
        stubFor(post(urlEqualTo("/api/v1/policies/conflicts"))
            ...
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"conflicts\":[],\"total_policies\":2,\"conflict_count\":0,\"checked_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"evaluation\"}")));
    ...
    void shouldSendPolicyIdWithSpecialCharactersInBody() {
        stubFor(post(urlEqualTo("/api/v1/policies/conflicts"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
                .withBody("{\"success\":true,\"data\":{\"conflicts\":[],\"total_policies\":1,\"conflict_count\":0,\"checked_at\":\"2026-03-24T10:00:00Z\",\"tier\":\"evaluation\"}}")));
