...
class CircuitBreakerTest {
  ...
  void shouldGetCircuitBreakerStatus() {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/status"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"active_circuits\":[{\"scope\":\"provider\",\"scope_id\":\"openai\",\"state\":\"open\",\"error_count\":15}],\"count\":1,\"emergency_stop_active\":false}}")));
        ...
        get(urlEqualTo("/api/v1/circuit-breaker/status"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"active_circuits\":[],\"count\":0,\"emergency_stop_active\":false}}")));
        ...
        get(urlEqualTo("/api/v1/circuit-breaker/status"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"active_circuits\":[],\"count\":0,\"emergency_stop_active\":true}}")));
  ...
  void getCircuitBreakerStatusAsyncShouldReturnFuture() throws Exception {
    ...
    CompletableFuture<CircuitBreakerStatusResponse> future =
        axonflow.getCircuitBreakerStatusAsync();
  ...
  void shouldGetCircuitBreakerHistory() {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/history?limit=10"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"history\":[{\"id\":\"cb_001\",\"org_id\":\"org_1\",\"scope\":\"provider\",\"scope_id\":\"openai\",\"state\":\"open\",\"trip_reason\":\"error_threshold\",\"tripped_by\":\"system\",\"tripped_at\":\"2026-03-16T10:00:00Z\",\"expires_at\":\"2026-03-16T10:05:00Z\",\"reset_by\":null,\"reset_at\":null,\"error_count\":15,\"violation_count\":0}],\"count\":1}}")));
  ...
  void shouldGetEmptyCircuitBreakerHistory() {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/history?limit=50"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
  ...
  void getCircuitBreakerHistoryAsyncShouldReturnFuture() throws Exception {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/history?limit=25"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
    ...
    CompletableFuture<CircuitBreakerHistoryResponse> future =
        axonflow.getCircuitBreakerHistoryAsync(25);
  ...
  void shouldGetCircuitBreakerConfig() {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/config?tenant_id=tenant_123"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"source\":\"tenant_override\",\"error_threshold\":10,\"violation_threshold\":5,\"window_seconds\":300,\"default_timeout_seconds\":60,\"max_timeout_seconds\":600,\"enable_auto_recovery\":true,\"tenant_id\":\"tenant_123\",\"overrides\":{\"provider_openai\":{\"error_threshold\":20}}}}")));
  ...
  void shouldGetCircuitBreakerConfigDefaults() {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/config?tenant_id=new_tenant"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"source\":\"default\",\"error_threshold\":5,\"violation_threshold\":3,\"window_seconds\":60,\"default_timeout_seconds\":30,\"max_timeout_seconds\":300,\"enable_auto_recovery\":false,\"tenant_id\":\"new_tenant\"}}")));
  ...
  void getCircuitBreakerConfigAsyncShouldReturnFuture() throws Exception {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/config?tenant_id=async_tenant"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"source\":\"default\",\"error_threshold\":5,\"violation_threshold\":3,\"window_seconds\":60,\"default_timeout_seconds\":30,\"max_timeout_seconds\":300,\"enable_auto_recovery\":false,\"tenant_id\":\"async_tenant\"}}")));

    CompletableFuture<CircuitBreakerConfig> future =
        axonflow.getCircuitBreakerConfigAsync("async_tenant");
  ...
  void shouldHandleServerErrorOnGetConfig() {
    stubFor(
        get(urlEqualTo("/api/v1/circuit-breaker/config?tenant_id=bad_tenant"))
            .willReturn(
                aResponse()
                    .withStatus(500)
                    .withHeader("Content-Type", "application/json")
  ...
  void shouldUpdateCircuitBreakerConfig() {
    stubFor(
        put(urlEqualTo("/api/v1/circuit-breaker/config"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"tenant_id\":\"tenant_123\",\"message\":\"Circuit breaker config updated for tenant\"}}")));

    CircuitBreakerConfigUpdate update =
    ...
    verify(
        putRequestedFor(urlEqualTo("/api/v1/circuit-breaker/config"))
        ...
        put(urlEqualTo("/api/v1/circuit-breaker/config"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"tenant_id\":\"tenant_456\",\"message\":\"Circuit breaker config updated for tenant\"}}")));

    CircuitBreakerConfigUpdate update =
        CircuitBreakerConfigUpdate.builder().tenantId("tenant_456").errorThreshold(20).build();
        ...
        put(urlEqualTo("/api/v1/circuit-breaker/config"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"success\":true,\"data\":{\"tenant_id\":\"tenant_async\",\"message\":\"Circuit breaker config updated for tenant\"}}")));

    CircuitBreakerConfigUpdate update =
        CircuitBreakerConfigUpdate.builder().tenantId("tenant_async").errorThreshold(10).build();

    CompletableFuture<CircuitBreakerConfigUpdateResponse> future =
        axonflow.updateCircuitBreakerConfigAsync(update);
  ...
  void shouldHandleServerErrorOnUpdateConfig() {
    ...
    CircuitBreakerConfigUpdate update =
        CircuitBreakerConfigUpdate.builder().tenantId("failing_tenant").errorThreshold(10).build();
        ...
        get(urlEqualTo("/api/v1/circuit-breaker/status"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader("Content-Type", "application/json")
                    .withBody(
                        "{\"active_circuits\":[],\"count\":0,\"emergency_stop_active\":false}")));
