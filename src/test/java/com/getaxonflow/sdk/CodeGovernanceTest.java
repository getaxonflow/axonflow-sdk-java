...
class CodeGovernanceTest {
  ...
  class CodeFileTests {
    ...
    void equalsAndHashCodeShouldWork() {
      CodeFile file1 =
          CodeFile.builder().path("src/App.java").content("code").action(FileAction.CREATE).build();
  ...
  class CreatePRRequestTests {
    ...
    void equalsAndHashCodeShouldWork() {
      CreatePRRequest r1 =
          CreatePRRequest.builder().owner("owner").repo("repo").title("title").build();
      CreatePRRequest r2 =
          CreatePRRequest.builder().owner("owner").repo("repo").title("title").build();
  ...
  class CreatePRResponseTests {
    ...
    void constructorShouldCreateResponse() {
      ...
      CreatePRResponse response =
          new CreatePRResponse(
              "pr-123", 42, "https://github.com/owner/repo/pull/42", "open", "feature-branch", now);
    ...
    void toStringShouldWork() {
      CreatePRResponse response =
          new CreatePRResponse("pr-123", 42, "url", "open", "branch", Instant.now());
