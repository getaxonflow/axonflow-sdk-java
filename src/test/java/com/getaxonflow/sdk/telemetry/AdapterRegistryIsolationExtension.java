 ...
 * its equivalent in an autouse conftest fixture: the isolation has to hold for tests that have never
 * heard of the registry, not only for the ones that use it deliberately. A test asserting an empty
 * {@code features} array should not need to know that another class registers adapters.
 */
