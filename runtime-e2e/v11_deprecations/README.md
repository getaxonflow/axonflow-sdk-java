...
| Step | Expected |
|---|---|
| `simulatePolicies`, `detectPolicyConflicts` | keep answering; each route reported exactly once, with `X-AxonFlow-Removed-In: v11.1` and the successor exactly `/api/v1/typed-policies` from the `Link` |
